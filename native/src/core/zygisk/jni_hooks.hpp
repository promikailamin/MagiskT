/**
 * Auto-generated JNI hook definitions for Zygote specialization methods.
 * Contains nativeForkAndSpecialize, nativeSpecializeAppProcess,
 * and nativeForkSystemServer hooks for all Android API levels
 * (L through U) and Samsung/Nubia variants.
 */
...
/** Pre-generated JNI hook definitions for all Android API levels and OEM variants. Each lambda wraps the original native method with pre/post specialization calls. */
struct JniHookDefinitions {
